...
#   - call model.invoke(state["messages"]) - a chat model accepts the
#     whole message list directly, so passing the full history in one call
#     is how the model "sees" earlier turns
